package co.saputra.imagemachine.component
...
import co.saputra.imagemachine.util.toPx

class OverlayScanner @JvmOverloads constructor(
    context: Context,
    ...
    private val qrScannerWidth = 320.toPx()
    private val qrScannerHeight = 320.toPx()
    ...
    private fun initBackground() = Path().apply {
    ...
    private fun initBox() = Path().apply {
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.apply {
            ...
            backgroundShape = initBackground()
            qrScannerShape = initBox()
